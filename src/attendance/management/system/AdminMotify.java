 ...
 * @author Asus
 */
public class AdminMotify extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BG.add(lecturer, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 390, 180, 180));
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Student Female_96px.png"))); // NOI18N
        student.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 20, -1, -1));

        jLabel19.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel19.setText("Student");
        student.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, -1, -1));

        BG.add(student, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 390, 170, -1));
    ...
    private void studentMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_studentMousePressed
        AdminMotifystudent v = new AdminMotifystudent();
        v.setVisible(true);
        this.setVisible(false);
    ...
    private void lecturerMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lecturerMousePressed
        AdminMotifylecturer v = new AdminMotifylecturer();
        v.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminMotify.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminMotify().setVisible(true);
            }
        });
    }

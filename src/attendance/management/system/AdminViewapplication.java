 ...
 * @author Asus
 */
public class AdminViewapplication extends javax.swing.JFrame {
    
    Vector data;

    public AdminViewapplication(Vector data, JPanel Attendancebutton, JPanel BG, JLabel Exitbutton, JPanel Motifybutton, JLabel Namelabel, JPanel Profilebutton, JPanel Registerbutton, JPanel Searchbutton, JPanel Sidepane, JPanel Viewbutton, JTable allapplication, JButton jButton1, JLabel jLabel1, JLabel jLabel10, JLabel jLabel11, JLabel jLabel12, JLabel jLabel13, JLabel jLabel2, JLabel jLabel23, JLabel jLabel24, JLabel jLabel25, JLabel jLabel3, JLabel jLabel4, JLabel jLabel5, JLabel jLabel6, JLabel jLabel7, JLabel jLabel8, JLabel jLabel9, JPanel jPanel3, JScrollPane jScrollPane1, JScrollPane jScrollPane2, JTable jTable1) throws HeadlessException {
        this.data = data;
        this.Attendancebutton = Attendancebutton;
        this.BG = BG;
        this.Exitbutton = Exitbutton;
        this.Motifybutton = Motifybutton;
        ...
        this.individualapp = jTable1;
    }

    
    public AdminViewapplication() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        individualapp = new javax.swing.JTable();
        jScrollPane2 = new javax.swing.JScrollPane();
        allapplication = new javax.swing.JTable();
        ...
        jLabel12.setText("Student Application");
        ...
        individualapp.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(individualapp);
        if (individualapp.getColumnModel().getColumnCount() > 0) {
            individualapp.getColumnModel().getColumn(2).setPreferredWidth(300);
        }

        BG.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 560, 560, 270));

        allapplication.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(allapplication);

        BG.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 280, 560, 190));
        ...
        BG.add(viewbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 490, 80, 30));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        //Show all the application on first table
        String line = null;
        DefaultTableModel dtm = (DefaultTableModel) allapplication.getModel();

        try {
            BufferedReader br = new BufferedReader(new FileReader("ALLapplication.txt"));
    ...
    private void viewbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewbuttonActionPerformed
        ...
        int i = allapplication.getSelectedRow();
        DefaultTableModel model2 = (DefaultTableModel)allapplication.getModel();
        
        //get student name and date from table one then combine together as a file name
        String name = model2.getValueAt(i, 0).toString();
        String date = model2.getValueAt(i, 1).toString();
        String application = name+date+"application.txt";
        
        String line = null;
        DefaultTableModel dtm = (DefaultTableModel) individualapp.getModel();

        try {
            BufferedReader br = new BufferedReader(new FileReader(application));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewapplication.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminViewapplication().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable allapplication;
    private javax.swing.JTable individualapp;

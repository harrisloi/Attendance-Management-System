...
public class AdminSearchstudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BG.add(Findbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 270, 90, 30));

        IDinput.setFont(new java.awt.Font("Malgun Gothic", 0, 18)); // NOI18N
        IDinput.setText("Enter Username");
        ...
        BG.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 440, -1, -1));

        jLabel40.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel40.setText("Course:");
        BG.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 360, -1, -1));
        ...
        BG.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 520, -1, -1));
        ...
        BG.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 320, -1, -1));
        ...
        BG.add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 480, -1, -1));

        dobfield.setEditable(false);
        BG.add(dobfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 480, 180, -1));

        subject.setEditable(false);
        BG.add(subject, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 400, 130, -1));
        ...
        BG.add(lecturer2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 520, 130, -1));

        lecturer1.setEditable(false);
        BG.add(lecturer1, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 440, 130, -1));
        ...
        BG.add(coursefield, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 360, 130, -1));
        ...
        BG.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 400, -1, -1));

        phonefield.setEditable(false);
        BG.add(phonefield, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 680, 182, -1));

        intakefield.setEditable(false);
        BG.add(intakefield, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 320, 130, -1));
        ...
        BG.add(subject2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 480, 130, -1));
        ...
        BG.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 805, 90, 30));

        jLabel19.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel19.setText("Password:");
        BG.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 560, -1, -1));

        passfield.setEditable(false);
        BG.add(passfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 560, 130, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (delete == JOptionPane.YES_OPTION)
        {
            ...
            String lec = lecturer1.getText()+ intake;
            String lec2 = lecturer2.getText()+intake;
            String remove = name+"|"+ idfield.getText()+"|"+subject.getText()+"|"+intakefield.getText()+"|"+coursefield.getText();
            String remove2 = name+"|"+ idfield.getText()+"|"+subject2.getText()+"|"+intakefield.getText()+"|"+coursefield.getText();
            String remove3 = name+"|"+ idfield.getText()+"|"+intakefield.getText()+"|"+coursefield.getText();
            
            //use constuctor to combine username and password together to delete user account in login file
            adminclass u = new adminclass();
            u.User(IDinput.getText(), passfield.getText());
            String user = u.Userlogin();
            
            //Delete Personal detail file
            File file = new File(name+".txt");
            file.delete();
            
            //Delete attendance file
            File file2 = new File(name+"attendance.txt");
            file2.delete();
            
            
            //remove students from lecturer list
            try{
            File inputFile = new File( lec+".txt");
            ...
            //remove students from lecturer2 list
            try{
            File inputFile = new File( lec2+".txt");
            File tempFile = new File("myTempFile2.txt");

            BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            BufferedWriter writer = new BufferedWriter(new FileWriter(tempFile));

            String lineToRemove = remove2;
            String currentLine;
            ...
            //remove students from student login list
            try{
            File inputFile = new File("studentlogin.txt");
            File tempFile = new File("myTempFile4.txt");
            ...
            //remove students from ALL students list
            try{
            File inputFile = new File("ALLstudents.txt");
            File tempFile = new File("myTempFile5.txt");

            BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            BufferedWriter writer = new BufferedWriter(new FileWriter(tempFile));

            String lineToRemove = remove3;
            String currentLine;

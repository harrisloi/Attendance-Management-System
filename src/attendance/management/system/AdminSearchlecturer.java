 ...
 * @author Asus
 */
public class AdminSearchlecturer extends javax.swing.JFrame {

    
    public AdminSearchlecturer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        BG.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 805, 80, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (delete == JOptionPane.YES_OPTION){
            ...
            //use constuctor to set User ID and Password
            u.User(IDinput.getText(), passfield.getText());
            String combine = u.Userlogin();
            String remove = name+intakefield.getText();
            String remove2 = name+intakefield2.getText();
            
            
            //Delete lecturer personal profile
            File file = new File(name+".txt");
            file.delete();
            
            
            //Delete lecturer intake file
            File file2 = new File(remove+".txt");
            file2.delete();
            
            
            //Delete lecturer intake file
            File file3 = new File(remove2+".txt");
            file3.delete();
            
            
            //remove lecturer from lecturer login file
            try{
            File inputFile = new File("lecturerlogin.txt");
            File tempFile = new File("myTempFile.txt");

            BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            BufferedWriter writer = new BufferedWriter(new FileWriter(tempFile));

            String lineToRemove = combine;
            String currentLine;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminSearchlecturer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminSearchlecturer().setVisible(true);
            }
        });
    }

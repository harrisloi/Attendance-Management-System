 ...
 * @author Asus
 */
public class AdminMotifystudent extends javax.swing.JFrame {

    
    public AdminMotifystudent() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminMotifystudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminMotifystudent().setVisible(true);
            }
        });
    }
